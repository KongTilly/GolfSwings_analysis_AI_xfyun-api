...
appid = "38a4d26d"    #填写控制台中获取的 APPID 信息
api_secret = "MDVjZDg0Yjc1NTMxYTFhODg1ZDBiYzUw"   #填写控制台中获取的 APISecret 信息
api_key ="cde00ee766f13b0ab9514a87beb41f83"    #填写控制台中获取的 APIKey 信息
imagedata = open("D:/A.Tilly_Kong/git_code/Kong_demo/model-result/006/慢视频/key_frames/Top_of_Backswing_263.jpg",'rb').read()
